...
Phaser.Tween.prototype = {
    ...
    * @param {number} [repeat=0] - Should the tween automatically restart once complete? If you want it to run forever set as Infinity. This ignores any chained tweens.
